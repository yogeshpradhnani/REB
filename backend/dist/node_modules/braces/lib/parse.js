...
var MAX_LENGTH = _require.MAX_LENGTH;
var CHAR_BACKSLASH = _require.CHAR_BACKSLASH;
var /* \ */
...
var CHAR_ZERO_WIDTH_NOBREAK_SPACE = _require.CHAR_ZERO_WIDTH_NOBREAK_SPACE;
...
var parse = function parse(input) {
  ...
  while (index < length) {
    ...
    if (value === CHAR_COMMA && depth > 0) {
      if (block.ranges > 0) {
        ...
        block.nodes = [_open2, { type: 'text', value: stringify(block) }];
      }
  ...
  do {
    ...
    if (block.type !== 'root') {
      ...
      var _index = _parent.nodes.indexOf(block);
      // replace the (invalid) block with it's nodes
      (_parent$nodes = _parent.nodes).splice.apply(_parent$nodes, [_index, 1].concat(_toConsumableArray(block.nodes)));
    }
